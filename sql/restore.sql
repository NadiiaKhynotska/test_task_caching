...
-- Перевірка на існування бази даних dvdrental
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'dvdrental') THEN
...
-- Створення ролі postgres, якщо вона ще не існує
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'postgres') THEN
CREATE ROLE postgres LOGIN PASSWORD 'your_password_here';
END IF;
END
$$;
...
-- Data for Name: actor; Type: TABLE DATA; Schema: public; Owner: postgresUser
\copy public.actor (actor_id, first_name, last_name, last_update) FROM '/data/3057.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: address; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/data/3065.dat' WITH DELIMITER E'\t' CSV NULL 'NULL'
-- Data for Name: category; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.category (category_id, name, last_update) FROM '/data/3059.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.city (city_id, city, country_id, last_update) FROM '/data/3067.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: country; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.country (country_id, country, last_update) FROM '/data/3069.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: customer; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/data/3055.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: film; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/data/3061.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: film_actor; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.film_actor (actor_id, film_id, last_update) FROM '/data/3062.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: film_category; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.film_category (film_id, category_id, last_update) FROM '/data/3063.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: inventory; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.inventory (inventory_id, film_id, store_id, last_update) FROM '/data/3071.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: language; Type: TABLE DATA; Schema: public; Owner: postgresUser
    \copy public.language (language_id, name, last_update) FROM '/data/3073.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: payment; Type: TABLE DATA; Schema: public; Owner: postgresUser
--     \copy public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/data/3075.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: rental; Type: TABLE DATA; Schema: public; Owner: postgresUser
--     \copy public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/data/3077.dat' WITH DELIMITER E'\t' CSV NULL 'NULL'
-- Data for Name: staff; Type: TABLE DATA; Schema: public; Owner: postgresUser
--     \copy public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/data/3079.dat' WITH DELIMITER E'\t' CSV

-- Data for Name: store; Type: TABLE DATA; Schema: public; Owner: postgresUser
--     \copy public.store (store_id, manager_staff_id, address_id, last_update) FROM '/data/3081.dat' WITH DELIMITER E'\t' CSV
